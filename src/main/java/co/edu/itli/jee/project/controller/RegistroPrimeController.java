 ...
 */
package co.edu.itli.jee.project.controller;
...
import co.edu.itli.jee.project.data.MemberRepository;
import co.edu.itli.jee.project.model.Member;
import co.edu.itli.jee.project.service.MemberRegistration;
...
public class RegistroPrimeController {
    ...
    public void register() throws Exception {
        try {
        	...
        	if(newMember==null) {FacesMessage m = new FacesMessage(FacesMessage.SEVERITY_ERROR, 
    ...
    public void remover(Long idAEliminar) throws Exception {
        try {
            ...
            consultarTodos();
            FacesMessage m = new FacesMessage(FacesMessage.SEVERITY_INFO, "Eliminado!", "REliminado id: "+idAEliminar);
            facesContext.addMessage(null, m);
    ...
    public void actualizar() throws Exception {
        try {
        	if(newMember==null && newMember.getId()!=null) {FacesMessage m = new FacesMessage(FacesMessage.SEVERITY_ERROR, 
        			"error!", "error inesperado");
            facesContext.addMessage(null, m);
            return;
    	}
            memberRegistration.actualizar(newMember);
            FacesMessage m = new FacesMessage(FacesMessage.SEVERITY_INFO, "Upgraded!", 
            		"Upgrade successful");
            facesContext.addMessage(null, m);
            initNewMember();
        } catch (Exception e) {
